...
public class DailySummaryDetailResponseDto : IStatsDetailResponseDto
{
    #region Constructors
    internal DailySummaryDetailResponseDto(int recordedYear, int recordedMonth, int recordedDay)
    {
        RecordedDate = new(recordedYear, recordedMonth, recordedDay);
    }

    internal DailySummaryDetailResponseDto(DateOnly recordedDate)
    {
        RecordedDate = recordedDate;
    }

    internal DailySummaryDetailResponseDto(DailySummary dailyStats)
    {
