...
public interface IRoleService
{
    ...
    /// </summary>
    /// <returns>
    /// A <see cref="Task"/> representing the asynchronous operation, which result is an a <see cref="List{T}"/> of
    /// <see cref="RoleMinimalResponseDto"/> DTOs, containing the results.
    /// </returns>
