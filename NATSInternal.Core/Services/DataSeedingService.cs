...
internal sealed class DataSeedingService
{
    ...
    private async Task SeedRoleClaimsAsync(List<Role> roles)
    {
        ...
        {
            {
                "Developer",
                new string[] {
                    PermissionNameConstants.CreateUser,
                    PermissionNameConstants.GetOtherUserNote,
                    PermissionNameConstants.EditSelfPersonalInformation,
                    PermissionNameConstants.EditSelfUserInformation,
                    PermissionNameConstants.EditOtherUserPersonalInformation,
                    PermissionNameConstants.EditOtherUserUserInformation,
                    PermissionNameConstants.AssignRole,
                    PermissionNameConstants.ResetOtherUserPassword,
                    PermissionNameConstants.DeleteUser,
                    PermissionNameConstants.GetCustomerDetail,
                    PermissionNameConstants.CreateCustomer,
                    PermissionNameConstants.EditCustomer,
                    PermissionNameConstants.DeleteCustomer,
                    PermissionNameConstants.CreateBrand,
                    PermissionNameConstants.EditBrand,
                    PermissionNameConstants.DeleteBrand,
                    PermissionNameConstants.CreateProductCategory,
                    PermissionNameConstants.EditProductCategory,
                    PermissionNameConstants.DeleteProductCategory,
                    PermissionNameConstants.CreateProduct,
                    PermissionNameConstants.EditProduct,
                    PermissionNameConstants.DeleteProduct,
                    PermissionNameConstants.CreateSupply,
                    PermissionNameConstants.EditSupply,
                    PermissionNameConstants.EditLockedSupply,
                    PermissionNameConstants.DeleteSupply,
                    PermissionNameConstants.SetSupplyStatsDateTime,
                    PermissionNameConstants.AccessSupplyUpdateHistories,
                    PermissionNameConstants.CreateExpense,
                    PermissionNameConstants.EditExpense,
                    PermissionNameConstants.EditLockedExpense,
                    PermissionNameConstants.DeleteExpense,
                    PermissionNameConstants.SetExpenseStatsDateTime,
                    PermissionNameConstants.AccessExpenseUpdateHistories,
                    PermissionNameConstants.CreateOrder,
                    PermissionNameConstants.EditOrder,
                    PermissionNameConstants.EditLockedOrder,
                    PermissionNameConstants.SetOrderStatsDateTime,
                    PermissionNameConstants.AccessOrderUpdateHistories,
                    PermissionNameConstants.DeleteOrder,
                    PermissionNameConstants.CreateTreatment,
                    PermissionNameConstants.EditTreatment,
                    PermissionNameConstants.EditLockedTreatment,
                    PermissionNameConstants.DeleteTreatment,
                    PermissionNameConstants.SetTreatmentStatsDateTime,
                    PermissionNameConstants.AccessTreatmentUpdateHistories,
                    PermissionNameConstants.CreateDebtIncurrence,
                    PermissionNameConstants.EditDebtIncurrence,
                    PermissionNameConstants.EditLockedDebtIncurrence,
                    PermissionNameConstants.DeleteDebtIncurrence,
                    PermissionNameConstants.SetDebtStatsDateTime,
                    PermissionNameConstants.AccessDebtIncurrenceUpdateHistories,
                    PermissionNameConstants.CreateDebtPayment,
                    PermissionNameConstants.EditDebtPayment,
                    PermissionNameConstants.EditLockedDebtPayment,
                    PermissionNameConstants.DeleteDebtPayment,
                    PermissionNameConstants.SetDebtPaymentStatsDateTime,
                    PermissionNameConstants.AccessDebtPaymentUpdateHistories,
                    PermissionNameConstants.CreateConsultant,
                    PermissionNameConstants.EditConsultant,
                    PermissionNameConstants.EditLockedConsultant,
                    PermissionNameConstants.DeleteConsultant,
                    PermissionNameConstants.SetConsultantStatsDateTime,
                    PermissionNameConstants.AccessConsultantUpdateHistories,
                    PermissionNameConstants.CreateAnnouncement,
                    PermissionNameConstants.EditAnnouncement,
                    PermissionNameConstants.DeleteAnnouncement
                }
            },
            {
                "Manager",
            ...
            },
            {
                ...
                new string[]
                {
                    PermissionNameConstants.GetOtherUserPersonalInformation,
                    PermissionNameConstants.GetOtherUserUserInformation,
                    PermissionNameConstants.EditSelfPersonalInformation,
                    PermissionNameConstants.GetCustomerDetail,
                    PermissionNameConstants.CreateCustomer,
                    PermissionNameConstants.CreateBrand,
    ...
    private async Task<List<User>> SeedUsersAsync()
    {
        ...
        Dictionary<User, (string Password, string RoleName)> usersWithPasswords;
        usersWithPasswords = new Dictionary<User, (string, string)>
        {
            {
                new User
                {
    ...
    private async Task<List<Brand>> SeedBrandsAsync()
    {
            ...
            List<Brand> brands)
    {
        ...
        Random random = new Random();
        List<int> categoryIds = categories.Select(pc => pc.Id).ToList();
        ...
        for (int i = 0; i < 30; i++)
        {
            ...
            Product product = new Product
            {
                ...
                CreatedDateTime = DateTime.UtcNow.ToApplicationTime(),
                BrandId = brandIds.Skip(random.Next(brandIds.Count)).Take(1).Single(),
                CategoryId = categoryIds.Skip(random.Next(categoryIds.Count)).Take(1).Single()
            };
            ...
            bool logResult = false)
    {
        ...
        List<int> userIds = _context.Users
            ...
            .Where(u => u.Roles
                ...
                .Contains(PermissionNameConstants.CreateSupply))
                .Select(u => u.Id)
                .ToList();
            ...
            bool logResult = false)
    {
        ...
        List<int> canCreateExpenseUserIds = await _context.Users
            .Where(u => u.Roles
                ...
                .Claims
                .Select(c => c.ClaimValue)
                .Contains(PermissionNameConstants.CreateExpense))
                .Select(u => u.Id)
                .ToListAsync();
        ...
        if (productsInStockCount > 0)
        {
            ...
            List<int> userIdsWhoCanCreateOrders = await _context.Users
                ...
                .Where(u => u.Roles
                    ...
                    .Claims
                    .Select(c => c.ClaimValue)
                    .Contains(PermissionNameConstants.CreateOrder))
                    .Select(u => u.Id)
                    .ToListAsync();
        ...
        if (productsInStockCount > 0)
        {
            ...
            List<int> userIdsWhoCanCreateTreatments = await _context.Users
                ...
                .Where(u => u.Roles
                    ...
                    .Claims
                    .Select(c => c.ClaimValue)
                    .Contains(PermissionNameConstants.CreateTreatment))
                    .Select(u => u.Id)
                    .ToListAsync();
            ...
            bool logResult = false)
    {
        ...
        List<int> userIds = _context.Users
            ...
            .Where(u => u.Roles
                ...
                .Claims
                .Select(c => c.ClaimValue)
                .Contains(PermissionNameConstants.CreateConsultant))
                .Select(u => u.Id)
                .ToList();
            ...
            bool logResult = false)
    {
        ...
        List<int> userIdsWhoCanCreateDebtPayments = await _context.Users
            ...
            .Where(u => u.Roles
                ...
                .Claims
                .Select(c => c.ClaimValue)
                .Contains(PermissionNameConstants.CreateDebtPayment))
                .Select(u => u.Id)
                .ToListAsync();
